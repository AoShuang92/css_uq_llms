...
def get_args():
    ...
    parser.add_argument('--gpt_thr', type=float, default='0.55')
    parser.add_argument('--rougeL_thr', type=float, default='0.2')
...
def main():
    ...
    result_file = "result_rouge_tempt.csv"
    ...
    models_all = ['gpt-3.5-turbo', 'llama-13b','opt-13b']
#     models_all = ['llama-13b','opt-13b']
#     data_all = ['coqa', 'nq_open' ]
    data_all = ['coqa' ]
...
if __name__ == "__main__": 
    ...
    args = get_args()
    print('temperature, threshold and pca_components',args.temperature, args.rougeL_thr, args.n_components )
    main()